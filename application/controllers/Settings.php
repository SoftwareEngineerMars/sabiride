...

{
...

    {
        ...
        $this->load->view('settings/paystacksetting', $data);

        $this->load->view('includes/footer', $getview);

    }

    public function binancepaysettings()

    {

        $getview['view'] = 'appsettings';

        $data['appsettings'] = $this->appset->getbinancepaybyid();
        ...
        $this->load->view('settings/binancepaysetting', $data);
...

    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $datadecimal             = [
                ...
                'value'                    => html_escape($this->input->post('decimal', TRUE))
            ...
            if (demo == TRUE) {
                ...
                if ($success) {
                    ...
                    $this->appset->editdecimal($datadecimal);
...

    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $data             = [
                ...
                'paystack_secret_key'                    => html_escape($this->input->post('stripe_secret_key', TRUE)),

                'paystack_published_key'                => html_escape($this->input->post('stripe_published_key', TRUE)),

                'paystack_status'                        => html_escape($this->input->post('stripe_status', TRUE)),

                'paystack_active'                        => html_escape($this->input->post('stripe_active', TRUE))
            ...
            if (demo == TRUE) {
                ...
                redirect('settings/paystacksettings');
    ...
    public function editbinancepay()

    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $data             = [
                ...
                'api_key'                    => html_escape($this->input->post('stripe_secret_key', TRUE)),

                'secret_key'                => html_escape($this->input->post('stripe_published_key', TRUE)),

                

                'enable'                        => html_escape($this->input->post('stripe_active', TRUE))
            ...
            if (demo == TRUE) {
                ...
                redirect('settings/binancepaysettings');

            } else {



                $success = $this->appset->editdatabinancepay($data);
