                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="item_name" class="form-control" name="item_name" placeholder="enter item name" value="<?= $item['item_name'] ?>" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <select class="select2 form-control" id="item_category" name="item_category" required>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <textarea class="form-control" id="item_desc" rows="3" name="item_desc" required><?= $item['item_desc'] ?></textarea>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="item_price" class="form-control" pattern="^\d+(\.|\,)\d{2}$" data-type="currency" name="item_price" value="<?= number_format($item['item_price'] / 100, 2, ".", ",") ?>" placeholder="enter item price" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-4 form-group">
                                                            ...
                                                            <select class="select2 form-control" id="promo_status" name="promo_status" onchange="editSelectCheck(this);">
                                                        ...
                                                        <div class="col-8">
                                                            <div class="form-group" id="yescheck" <?php if ($item['promo_status'] == 1) { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?>>
                                                                ...
                                                                <input type="text" class="form-control" pattern="^\d+(\.|\,)\d{2}$" data-type="currency" name="promo_price" value="<?= number_format($item['promo_price'] / 100, 2, ".", ",") ?>" placeholder="enter promo price">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <select class="select2 form-control" id="item_status" name="item_status" required>
