                            ...
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar bg-rgba-success p-50 m-0">
                                    <div class="avatar-content">
                                        <a href="<?= base_url(); ?>user/customerdata" class="feather icon-user text-success font-medium-5"></a>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar bg-rgba-danger p-50 m-0">
                                    <div class="avatar-content">
                                        <a href="<?= base_url(); ?>user/driverdata" class="feather icon-users text-danger font-medium-5"></a>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar bg-rgba-warning p-50 m-0">
                                    <div class="avatar-content">
                                        <a href="<?= base_url(); ?>user/merchantdata" class="feather icon-shopping-bag text-warning font-medium-5"></a>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar bg-rgba-info p-50 m-0">
                                    <div class="avatar-content">
                                        <a href="<?= base_url(); ?>historytransaction" class="feather icon-refresh-ccw text-info font-medium-5"></a>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($transaction as $tr) { ?>
                                                    <tr>
                                                        ...
                                                        <th><?= $currency ?>
                                                            <?= number_format($tr['final_cost'] / 100, $decimal, ".", ",") ?></th>
                                                        <th>
