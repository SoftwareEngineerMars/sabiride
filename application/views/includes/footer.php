...
<?php if ($view == "extensions") { ?>
    <script src="<?= base_url(); ?>asset/app-assets/js/scripts/ourdevelops/typed.min.js"></script>
    <script src="<?= base_url(); ?>asset/app-assets/js/scripts/ourdevelops/typed.js"></script>
<?php } ?>
...
<?php } ?>
<script src="<?= base_url(); ?>asset/app-assets/js/scripts/ourdevelops/progresbar.js"></script>
