                ...
                <div class="col-md-8 col-12">
                    <div class="card">
                        <div class="card-header">
                           <a href="<?php echo base_url(); ?>Investment/Investment_merchant_list"><button class="btn btn-success">Back</button></a> 
                           <h4 class="card-title"> Investment Mercent</h4>
                        </div>
                        <section id="basic-vertical-layouts">
                            <div class="card-content">
                                <div class="card-body">
                                    <?= form_open_multipart('Investment/addInvestmentformercent'); ?>
                                    <form class="form form-vertical">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 form-group">
                                                    <label for="customer_id">Select Mercent</label>
                                                    <select class="select2 form-control" style="width:100%" name="customer_id" id="customer_id">
                                                        <?php foreach($mercentlist as $mercentlistlistsingle){ ?>
                                                        <option value="<?php echo $mercentlistlistsingle->merchant_id; ?>"><?php echo $mercentlistlistsingle->merchant_name; ?>(<?php echo $mercentlistlistsingle->merchant_id; ?>) </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
