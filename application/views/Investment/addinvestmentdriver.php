                ...
                <div class="col-md-8 col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="<?php echo base_url(); ?>Investment/Investment_driver_list"><button class="btn btn-success">Back</button></a> <br>
                          
                           <h4 class="card-title"> Investment Driver</h4>
                        </div>
                        <section id="basic-vertical-layouts">
                            <div class="card-content">
                                <div class="card-body">
                                    <?= form_open_multipart('Investment/addInvestmentfordriver'); ?>
                                    <form class="form form-vertical">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 form-group">
                                                    <label for="customer_id">Select Driver</label>
                                                    <select class="select2 form-control" style="width:100%" name="customer_id" id="customer_id">
                                                        <?php foreach($driverlist as $driverlistlistsingle){ ?>
                                                        <option value="<?php echo $driverlistlistsingle->id; ?>"><?php echo $driverlistlistsingle->driver_name; ?>(<?php echo $driverlistlistsingle->id; ?>) </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
