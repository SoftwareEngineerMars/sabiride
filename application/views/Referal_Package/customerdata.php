...
<h4 class="card-title">Customer Referal Package Data</h4>
</div>
                    ...
                    <tbody>
                        ...
                        foreach ($customer as $cstm) { ?>
                            <tr>
                                ...
                                <td><?= $cstm['rpc_package_name'] ?></td>
                                <td><?= $cstm['rpc_package_currency'] ?><?= $cstm['rpc_package_amount'] ?></td>
                                <td><?= $cstm['rpc_ceated_date'] ?></td>
                                <td><?= $cstm['rpc_referal_code'] ?></td>
                               
                                <td>
                                    <?php if ($cstm['rpc_status'] == 1) { ?>
                                ...
                                <td>
                                    <span class="">
                                        <a href="<?= base_url(); ?>Referal_package/Referal_package_customer_list_detail/<?= $cstm['id'] ?>/<?= $cstm['rpc_id'] ?>/<?= $cstm['rpc_referal_code'] ?>">
                                            <i class="feather icon-eye text-info"></i>
                                        </a>
                                    </span>
                                    <?php if ($cstm['status'] == 0) { ?>
                                        <span class="mr-1 ml-1">
                                            <a href="<?= base_url(); ?>Referal_package/unblock/<?= $cstm['id']; ?>">
                                                <i class="feather icon-lock text-danger"></i>
                                            </a>
                                        </span>
                                    <?php } else { ?>
                                        <span class="mr-1 ml-1">
                                            <a href="<?= base_url(); ?>Referal_package/block/<?= $cstm['id']; ?>">
                                                <i class="feather icon-unlock text-success"></i>
                                            </a>
                                        </span>
                                    <?php } ?>
                                    <span class="action-delete ml-1">
                                        <a onclick="return confirm ('Are You Sure?')" href="<?= base_url(); ?>Referal_package/deleteusers/<?= $cstm['rpc_id']; ?>">
