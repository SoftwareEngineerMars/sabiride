...
<h4 class="card-title">Driver Money Hold On And Detail </h4>
</div>
            ...
            <div class="table-responsive">
                <table class="table table-striped dataex-html5-selectors">
                    ...
                    <tbody>
                        ...
                        if(!empty($driver)){ 
                        foreach ($driver as $cstm) { ?>
                            <tr>
                                <td><?= $i ?></td>
                                <td>
                                       <img class="round" style="width: 40px; height: 40px;" src="<?= base_url('images/driverphoto/') . $cstm['photo']; ?>">
                                </td>
                              
                                <td>
                                     <b>UserId:</b> <?= $cstm['id'] ?> <br>
                             <b>Full Name:</b> <?= $cstm['driver_name'] ?> <br>
                             <!-- <b>Job:</b> <?= $cstm['driver_job'] ?> <br> -->
                             <b>Mobile:</b>  <?= $cstm['phone_number'] ?>
