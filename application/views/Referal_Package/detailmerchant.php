                        ...
                        <div class="card-content">
                            <div class="card-body text-center mx-auto">
                                <div class="avatar avatar-xl">
                                    <img class="img-fluid" src="<?= base_url('images/merchant/') . $partner['merchant_image'] ?>" alt="img placeholder">
                                </div>
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    ...
                                    <div class="following">
                                        <p class="font-weight-bold font-medium-2 mb-0"><?= $currency ?>
                                            <?= number_format($partner['balance'] / 100, $decimal, ".", ",") ?></p>
                                ...
                                <ul class="activity-timeline timeline-left list-unstyled">
                                    <li>
                                        ...
                                        <div class="timeline-info">
                                            ...
                                            <p>Id card number :
                                                <span class="text-muted"><?= $partner['partner_identity_number'] ?></span>
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="merchantwallet-tab" data-toggle="tab" href="#merchantwallet" aria-controls="merchantwallet" role="tab" aria-selected="false">User Join With Referal Detail</a>
                                        </li>
                                    </ul>
                                                                                ...
                                                                                foreach ($item as $it) { ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <?php if ($it['promo_status'] == 0) { ?>
                                                                                            <td><?= $currency ?><?= number_format($it['item_price'] / 100, $decimal, ".", ",") ?></td>
                                                                                        <?php } else { ?>
                                                                                            <td style="text-decoration: line-through;"><?= $currency ?><?= number_format($it['item_price'] / 100, $decimal, ".", ",") ?></td>
                                                                                        <?php } ?>
                                                                                        <?php if ($it['promo_status'] == 1) { ?>
                                                                                            <td class="text-success"><?= $currency ?><?= number_format($it['promo_price'] / 100, $decimal, ".", ",") ?></td>
                                                                                        <?php } else { ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="partner_name" class="form-control" name="partner_name" placeholder="enter owner name" value="<?= $partner['partner_name'] ?>" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="partner_email" class="form-control" name="partner_email" placeholder="enter email" value="<?= $partner['partner_email'] ?>" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="partner_type_identity" class="form-control" name="partner_type_identity" placeholder="enter type of id card" value="<?= $partner['partner_type_identity'] ?>" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="partner_identity_number" class="form-control" name="partner_identity_number" placeholder="enter number of id card" value="<?= $partner['partner_identity_number'] ?>" required="required">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="merchant_name" class="form-control" name="merchant_name" placeholder="enter merchant name" value="<?= $partner['merchant_name'] ?>" required="required">
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="latitude" class="form-control" name="merchant_latitude" placeholder="enter latitude" value="<?= $partner['merchant_latitude'] ?>" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="longitude" class="form-control" name="merchant_longitude" placeholder="enter logitude" value="<?= $partner['merchant_longitude'] ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="open_hour" class="form-control" name="open_hour" placeholder="enter open hour" value="<?= $partner['open_hour'] ?>" required="required">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="close_hour" class="form-control" name="close_hour" placeholder="enter close hour" value="<?= $partner['close_hour'] ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="category_name_item" placeholder="enter category item name" required="required">
                                    </div>
                                </div>
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="category_name_item">Category item name</label>
                                        <input type="text" id="itemcategoryname" class="form-control" name="category_name_item" placeholder="enter category item name" required="required">
                                    </div>
                                </div>
