                                    ...
                                    <div class="col-sm-6 col-12 text-right">
                                        ...
                                        <div class="invoice-details mt-2">
                                            ...
                                            <p>
                                                <?= $transaction['note'] ?>
                                                <span class="ml-2">
                                                    <i class="feather icon-star text-warning"></i><?= $transaction['rate'] ?></span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <?php foreach ($itemtransaction as $item) { ?>
                                                                <ul class="list-group list-group-flush">
                                                                    <li class="list-group-item">
                                                                        <?= $currency ?>
                                                                        <?= number_format($item['total_cost'] / 100, $decimal, ".", ",") ?>
                                                                    </li>
                                                                </ul>
                                                            <?php } ?>
                                                        </td>
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= $currency ?>
                                                            <?= number_format($transaction['cost'] / 100, $decimal, ".", ",") ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?= $currency ?>
                                                            <?= number_format($transaction['price'] / 100, $decimal, ".", ",") ?>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        <tr>
                                                            <th>ITEM PRICE</th>
                                                            <td><?= $currency ?>
                                                                <?= number_format($transaction['total_belanja'] / 100, $decimal, ".", ",") ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>DELIVERY</th>
                                                            <td><?= $currency ?>
                                                                <?= number_format($transaction['price'] / 100, $decimal, ".", ",") ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>DISCOUNT
                                                            ...
                                                            <td class="text-danger">
                                                                <?= $currency ?>
                                                                <?= number_format($transaction['promo_discount'] / 100, $decimal, ".", ",") ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>PAYMENT</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="card-title"><?= $currency ?>
                                                                <?= number_format($transaction['final_cost'] / 100, $decimal, ".", ",") ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="card-title">
                                                                <?= $currency ?>
                                                                <?= number_format($transaction['final_cost'] / 100, $decimal, ".", ",") ?>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
