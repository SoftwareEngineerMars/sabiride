    ...
    var defaults = {
        ...
        methods: {
            init: function (options) {
                ...
                $(uniqueForms).on('bind',"submit.validationSubmit", function (e) {
                    var $form = $(this);
                    var warningsFound = 0;
                    // Get all inputs
                ...
                return this.each(function () {
                    ...
                    $this.on('bind',"getValidatorCount.validation", function () {
                    ...
                    $this.on('bind',"validationLostFocus.validation", function () {
                        if( settings.options.removeSuccess ){
                            // $controlGroup.removeClass("validate");
                        }
                    });
        ...
        validatorTypes: {
            ...
            match: {
                ...
                init: function ($this, name) {
                    ...
                    $element.on('bind',"validation.validation", function () {
            ...
            maxchecked: {
                ...
                init: function ($this, name) {
                    ...
                    elements.on('bind',"change.validation click.validation", function () {
