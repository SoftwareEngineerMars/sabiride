...
class Merchantdata_model extends CI_model
{
    ...
    public function editmerchantbyid($data, $data2, $data3)
    {
        ...
        if ($file) {
            ...
            $datapartner = $this->db->update('partner', $data);

            if ($datapartner) {

                $this->db->where('merchant_id', $data3['merchant_id']);
                return $this->db->update('merchant', $data3);
            }
