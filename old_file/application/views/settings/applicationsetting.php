                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="appcurrency">Decimal</label>
                                                            <select class="select2 form-group" name="decimal" id="decimal">
                                                                <option value="0" <?php if ($decimal == '0') { ?>selected<?php } ?>>Without Decimal</option>
                                                                <option value="2" <?php if ($decimal == '2') { ?>selected<?php } ?>>With Decimal</option>
                                                            </select>
                                                        </div>
                                                    </div>
