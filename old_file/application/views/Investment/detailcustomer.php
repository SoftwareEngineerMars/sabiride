                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="Withdraw_investment-tab" data-toggle="tab" href="#Withdraw_investment" aria-controls="Withdraw_investment" role="tab" aria-selected="false">Withdraw / Deposite</a>
                                        </li>
                                    </ul>
                                                                                ...
                                                                                foreach ($countorder as $tr) { ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-success">
                                                                                            <?= $currency ?>
                                                                                            <?= number_format($tr['final_cost'] / 100, $decimal, ".", ",") ?>
                                                                                        </td>
                                                                                        <td>
                                                                                            <?php if ($tr['status'] == '0') { ?>
                                            ...
                                            <section id="column-selectors">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <h4 class="card-title">Driver Withdraw History</h4>
                                                            </div>
                                                            <div class="card-content">
                                                                <div class="card-body card-dashboard">
                                                                    <div class="table-responsive">
