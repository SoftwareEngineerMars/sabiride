                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="partner_name" class="form-control" name="partner_name" placeholder="enter owner name" required="required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" id="partner_email" class="form-control" name="partner_email" placeholder="enter email" required="required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="partner_type_identity" class="form-control" name="partner_type_identity" placeholder="enter type of id card" required="required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="partner_identity_number" class="form-control" name="partner_identity_number" placeholder="enter number of id card" required="required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" id="password" class="form-control" name="password" placeholder="enter password" required="required">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="merchant_name" class="form-control" name="merchant_name" placeholder="enter merchant name" required="required">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="latitude" class="form-control" name="merchant_latitude" placeholder="enter latitude" required="required">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="longitude" class="form-control" name="merchant_longitude" placeholder="enter logitude" required="required">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="open_hour" class="form-control" name="open_hour" placeholder="enter open hour" required="required">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="close_hour" class="form-control" name="close_hour" placeholder="enter close hour" required="required">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
